...
class PartyAssignRoles extends Component
{
    // working
    public $showForm;
    public $formType;
    ...
    public function mount($modelId)
    {
        ...
        $this->model = Party::find($this->modelId);
    ...
    public function removeAllRoles()
    {
        ...
        return redirect()->route('parties.show', $this->model->sid)->with('toast', [
            'class' => 'success',
            'text' => 'All Role removed successfully.'
        ]);
    }
    ...
    {
        return view('brandy::livewire.party-assign-roles');
    }
}
